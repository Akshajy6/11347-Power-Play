...
public class ExampleMotorTeleOp extends LinearOpMode {
    ...
    ExampleMotorProgramming emp;

    //
    @Override

    //Moves motor in one direction
...
/*      This creates a previous (p1) and current (c1) gamepad in order to detect
        ...
        emp = new ExampleMotorProgramming(ExampleMotor);
